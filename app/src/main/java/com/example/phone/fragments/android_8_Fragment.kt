...
import com.example.phone.adapters.Grid_Adapter
import com.example.phone.databinding.FragmentAndroid8Binding
import com.example.phone.interfaces.OnGridClick
...
class android_8_Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_android_8_, container, false)
